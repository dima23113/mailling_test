...
````
git clone https://github.com/dima23113/mailling_test.git
````
...
````
5. В файле .evn заполнить необходимые данные: ```SECRET_KEY = '<your token>'```
...
```
2. Перейти в директорию проекта
3. В файле .evn заполнить необходимые данные: ```SECRET_KEY = '<your token>'```
