...
class TestStat(APITestCase):
    ...
    def test_mailing(self):
        ...
        response = self.client.post('http://127.0.0.1:8000/api/v1/mailings/', mail_create)
    ...
    def test_client(self):
        ...
        response = self.client.post('http://127.0.0.1:8000/api/v1/clients/', client_create)
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_stat(self):
        self.test_mailing()
        url = 'http://127.0.0.1:8000/api/v1/mailings'
